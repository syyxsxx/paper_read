...
| [H3-World: Turning Language Understanding into World Control](./h3world/analysis.md) | h3world | A 交互式视频世界模型 | Tencent+NUS+HKPolyU, 2026-09 | 把键盘动作翻译成 per-latent 自然语言句子，有向注意力掩码精确绑定每帧，0.199% LoRA 参数（65.6M）将 33B MiniMax-H3 变成可交互世界模型 |
